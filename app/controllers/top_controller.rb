class TopController < ApplicationController
  def all
    ...
    @allow_prev = !top_all_buf[@start-10...@start].nil? && top_all_buf[@start-10...@start].any?
  ...
  def hour
    ...
    @allow_prev = !top_hour_buf[@start-10...@start].nil? && top_hour_buf[@start-10...@start].any?
  ...
  def day
    ...
    @allow_prev = !top_day_buf[@start-10...@start].nil? && top_day_buf[@start-10...@start].any?
  ...
  def month
    ...
    @allow_prev = !top_month_buf[@start-10...@start].nil? && top_month_buf[@start-10...@start].any?
